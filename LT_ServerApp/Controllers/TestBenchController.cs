...
namespace LT_ServerApp.Controllers
{
    public class TestBenchController : Controller
    {
        ...
        public string GetTables(string rowId)
        {
            int id = 0;
            ...
            dt = _service.GetTestBenchTable(id);

            return JsonConvert.SerializeObject(dt);
        }

        [HttpGet]
        public string GetTableList(int rowId)
        {

            List<TableModel> dt = _service.GetTableList(rowId);
